...
class Summa:
    def __init__(self, sovellus, io): #self._sovellus, self._lue.syote
        self._sovellus = sovellus
        self.io = io

    def suorita(self):
        try: 
            arvo = int(self.io()) #en jaksanu virittää try-exceptejä
            self._sovellus._edellinen = self._sovellus.arvo()
            self._sovellus.plus(arvo)
        except:
            pass #kuka tomppeli laittaa kirjaimia laskimeen?
...
class Kumoa:
    ...
    def suorita(self):
        self._sovellus.aseta_arvo(self._sovellus._edellinen)